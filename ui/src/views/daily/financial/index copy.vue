<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="财务明细表主键" prop="financialDetailId">
        <el-input
          v-model="queryParams.financialDetailId"
          placeholder="请输入财务明细表主键"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['finanical:info:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['finanical:info:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['finanical:info:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="infoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="财务明细表主键" align="center" prop="financialDetailId" />
  ...
  data() {
    return {
      ...
      rules: {
        ...
        financialDetailId: [
          { required: true, message: "财务明细表主键不能为空", trigger: "blur" }
        ]
      }
    };
  },
